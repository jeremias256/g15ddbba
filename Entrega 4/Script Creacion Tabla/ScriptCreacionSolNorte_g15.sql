...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'SolNorte')
BEGIN
    CREATE DATABASE SolNorte;
END
GO
...
-- Aquí puedes agregar otros scripts adicionales de creación, índices, procedimientos, etc.
